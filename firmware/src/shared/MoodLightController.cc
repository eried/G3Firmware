...
const static PROGMEM prog_uchar script0 [] = "(Estado)";
const static PROGMEM prog_uchar script1 [] = "Personal";
const static PROGMEM prog_uchar script2 [] = "Apagado";
const static PROGMEM prog_uchar script3 [] = "Blanco";
const static PROGMEM prog_uchar script4 [] = "Rojo";
const static PROGMEM prog_uchar script5 [] = "Verde";
const static PROGMEM prog_uchar script6 [] = "Azul";
const static PROGMEM prog_uchar script7 [] = "Cian";
const static PROGMEM prog_uchar script8 [] = "Magenta";
const static PROGMEM prog_uchar script9 [] = "Amarillo";
const static PROGMEM prog_uchar script10[] = "Purpura";
const static PROGMEM prog_uchar script11[] = "Naranjo";
const static PROGMEM prog_uchar script12[] = "Almendra";
const static PROGMEM prog_uchar script13[] = "Durazno";
const static PROGMEM prog_uchar script14[] = "Menta";
const static PROGMEM prog_uchar script15[] = "Azul suave";
const static PROGMEM prog_uchar script16[] = "Lavanda";
const static PROGMEM prog_uchar script17[] = "Rosa suave";
const static PROGMEM prog_uchar script18[] = "Pizarra";
const static PROGMEM prog_uchar script19[] = "Gris";
const static PROGMEM prog_uchar script20[] = "Gris suave";
const static PROGMEM prog_uchar script21[] = "Azul noche";
const static PROGMEM prog_uchar script22[] = "Azulado";
const static PROGMEM prog_uchar script23[] = "Oliva";
const static PROGMEM prog_uchar script24[] = "Bosque";
const static PROGMEM prog_uchar script25[] = "Oro";
const static PROGMEM prog_uchar script26[] = "Rosado";
const static PROGMEM prog_uchar script27[] = "Lino";
const static PROGMEM prog_uchar script100[] = "WRGB*";
const static PROGMEM prog_uchar script101[] = "RGB*";
const static PROGMEM prog_uchar script102[] = "Blanco*";
const static PROGMEM prog_uchar script103[] = "Rojo*";
const static PROGMEM prog_uchar script104[] = "Verde*";
const static PROGMEM prog_uchar script105[] = "Azul*";
const static PROGMEM prog_uchar script106[] = "Cian*";
const static PROGMEM prog_uchar script107[] = "Magenta*";
const static PROGMEM prog_uchar script108[] = "Amarillo*";
const static PROGMEM prog_uchar script109[] = "Negro";
const static PROGMEM prog_uchar script110[] = "Tonos*";
const static PROGMEM prog_uchar script111[] = "Animo*";
const static PROGMEM prog_uchar script112[] = "Velas*";
const static PROGMEM prog_uchar script113[] = "Agua*";
const static PROGMEM prog_uchar script114[] = "Neon*";
const static PROGMEM prog_uchar script115[] = "Estacione*";
const static PROGMEM prog_uchar script116[] = "Tormenta*";
const static PROGMEM prog_uchar script117[] = "Semaforo*";
